...
namespace ArcadeVP
{
    public class ArcadeVehicleController : MonoBehaviour
    {
        ...
        private void Update()
        {
            horizontalInput =  GF.StaticUI.Joystick.GetHorizontalAxis();//Input.GetAxis("Horizontal"); //turning input
            verticalInput =  GF.StaticUI.Joystick.GetVerticalAxis();//Input.GetAxis("Vertical");     //accelaration input
            Visuals();
            AudioManager();
